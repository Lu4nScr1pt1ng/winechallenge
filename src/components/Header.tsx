...
import logo from "../../public/images/header/logoreal.png";
      ...
      <div className="container mx-auto h-[74px] md:h-[88px]">
        <div className="flex h-[100%] w-[100%] justify-between">
          <div className="flex h-[100%] items-center gap-4">
            ...
            <div className="w-[78px] h-[28px] mt-1 md:w-[100px]">
              <Image alt="wine logo" src={logo} layout="responsive" />
            </div>
